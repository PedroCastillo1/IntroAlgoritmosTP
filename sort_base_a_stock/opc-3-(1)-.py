...
remeras=[ "Producto A", "Producto B", "Producto C", "Producto D", "Producto E",]
sremeras=[1,22,3,4]
memuerovirgen=["Producto A","Producto B","Producto C","Producto D","Producto E",]
spantalones=[4,2,5,7]
...
pnspan=list(zip(memuerovirgen, spantalones))
'''
...
lamba es para no tener q escribir otro def. "x:x[1]" es para que el sort sea en base al stock, la cual es la segunda variable en las tuplas. 
'''
def sort(pns):
